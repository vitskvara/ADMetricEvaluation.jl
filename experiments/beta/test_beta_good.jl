...
alldf_val[!, [:model, :params, :auc, :auc_at_5, :bauc_at_5, :measure_at_5]]
alldf_val_alt[!, [:model, :params, :auc,:tpr_at_5, :auc_at_5, :bauc_at_5, :measure_at_5]]

# get the maxima and their hyperparams
...
# │ 1   │ pendigits-4-0 │ OCSVM  │ gamma=5.0 │ 0.911724 │ 0.982334 │ 0.94875   │ 0.99      │ 0.999825 │
model = OCSVM_model(5.0)
...
beta_auc(scores, y_val, 0.05, 1000)
...
savefig(joinpath(savepath, "good_fpr_fit.png"))
